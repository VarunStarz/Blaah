                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      TextFormField(
                        validator: (val){
                          return val.isEmpty || val.length < 3 ? "Field should not be empty and the length should be greater then 2" : null;
                        },
                      ...
                      TextFormField(
                        obscureText: true,
                        validator: (val){
                          return val.length > 6 ? null : "Password mustt contain greater than 6 characters";
                        },
