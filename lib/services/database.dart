...
class DatabaseMethods{
  ...
  createOrderRoom(String orderRoomId, orderRoomMap){
    Firestore.instance.collection("OrderRoom").document(orderRoomId).setData(orderRoomMap).catchError((e){
      print(e.toString());
    });
  }

  getOrderRooms(String userName) async {
    return await Firestore.instance.collection("OrderRoom").where("users", arrayContains: userName).snapshots();
  }
}
